...
This document contains supplementary material for our visualization of couples' money arrangements in Germany. The code files used for editing the source data and generating the visualization as well as this document (including the tables) are available on GitHub (link to the repository will be added after review).
